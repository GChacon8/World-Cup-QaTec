...
(define (drawBall x y)
  ;(send (send canvas get-dc) draw-bitmap (read-bitmap "./images/ball1.png" #:backing-scale 10) x y)
  (send (send canvas get-dc) draw-ellipse x y 10 10)
...
(define (moverBola2 x y fx fy)
  (drawBall x y)
  (moverBola2 (+ x fx) (+ y fy) fx fy))

(define(moverBola_aux)
  (moverBola2 10 10 5 5))
